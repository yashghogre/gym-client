  ...
  return (
    <main className={styles.mmDiv}>
      ...
      <div className={styles.featuresDiv} id="features" style={{ paddingTop: '5vh' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', gap: '0vh', marginBottom: '5vh' }} className={styles.fCardsDiv}>
          <div style={{ width: '55vw', display: 'flex', justifyContent: 'flex-start' }} className={styles.featCard} >
          ...
          <div style={{ width: '55vw', display: 'flex', justifyContent: 'flex-end', marginTop: '-20vh' }} className={styles.featCard} >
          ...
          <div style={{ width: '55vw', display: 'flex', justifyContent: 'flex-start', marginTop: '-5vh' }} className={styles.featCard} >
