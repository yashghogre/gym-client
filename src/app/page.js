  ...
  return (
    <main className={styles.mmDiv}>
      ...
      <div className={styles.featuresDiv} id="features" style={{ paddingTop: '5vh' }}>
        ...
        <div className={styles.fCardsDiv}>
          <div className={styles.featCard1} >
          ...
          <div className={styles.featCard2} >
          ...
          <div className={styles.featCard3} >
          ...
          <div className={styles.featCard4} >
